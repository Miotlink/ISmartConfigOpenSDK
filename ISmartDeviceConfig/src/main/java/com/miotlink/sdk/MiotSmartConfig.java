...
import com.miotlink.sdk.smart.SmartConfigAndMulticase;
import com.miotlink.sdk.smart.SmartConfigAndSmartConfigMulticase;
import com.miotlink.sdk.socket.Tools;
import com.miotlink.sdk.util.JsonUtil;
import com.miotlink.sdk.util.MacUtil;
import com.miotlink.sdk.util.Mlcc_ParseUtils;
...
public class MiotSmartConfig {
	...
	public void SmartConfig(int type, String routeName, String Password,
		...
		if (firstDatas != null) {
			...
			firstDatas= Utils.Consts.smartList;
		}
		switch (type) {
		case 1:
